...
angles = [random.randint(40, 360) for _ in range(50)]
...
def rotated_data_creation(folder_path, angle_list):
...
path, angles = rotated_data_creation(current_folder_path, angles)
